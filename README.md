...
| ---------- |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| v1.9       | [![GitHub release (by tag)](https://img.shields.io/github/downloads/Delppine1024/TGreen/v1.9.5/total?label=Download%40v1.9.5&style=flat)](https://github.com/Delppine1024/TGreen/releases/tag/v1.9.5) [![GitHub release (by tag)](https://img.shields.io/github/downloads/Delppine1024/TGreen/v1.9.4/total?label=Download%40v1.9.4&style=flat)](https://github.com/Delppine1024/TGreen/releases/tag/v1.9.4) [![GitHub release (by tag)](https://img.shields.io/github/downloads/Delppine1024/TGreen/v1.9.3/total?label=Download%40v1.9.3&style=flat)](https://github.com/Delppine1024/TGreen/releases/tag/v1.9.3)   |
| v1.9.x-dev | [![GitHub release (by tag)](https://img.shields.io/github/downloads/Delppine1024/TGreen/v1.9.2-dev/total?label=Download%40v1.9.2-dev&style=flat)](https://github.com/Delppine1024/TGreen/releases/tag/v1.9.2-dev)                                                                                                                                                                                                                                                                                                                                                                                                   |
| v1.8.x     | [![GitHub release (by tag)](https://img.shields.io/github/downloads/Delppine1024/TGreen/v1.8.10/total?label=Download%40v1.8.10&style=flat)](https://github.com/Delppine1024/TGreen/releases/tag/v1.8.10)[![GitHub release (by tag)](https://img.shields.io/github/downloads/Delppine1024/TGreen/v1.8.9/total?label=Download%40v1.8.9&style=flat)](https://github.com/Delppine1024/TGreen/releases/tag/v1.8.9) [![GitHub release (by tag)](https://img.shields.io/github/downloads/Delppine1024/TGreen/v1.8.5/total?label=Download%40v1.8.5&style=flat)](https://github.com/Delppine1024/TGreen/releases/tag/v1.8.5) |
...
Some crack files work well on Txxxxx v1.1 (The latest support v1.9.5/v1.9.2-dev), Based on txxxxxCracker. 查看 **简体中文** 文档请戳 [这里](./README-CN.md) 。查看 **繁體中文** 文档請點擊 [這裡](./README-TW.md) 。
...
| Timeline   | Actions                                                      |
| ---------- | ------------------------------------------------------------ |
| 2024.7.4   | Add support all in one for v1.9.4 - v1.9.5 on Windows x86/x64 |
| 2024.6.30  | Add support for v1.9.3 on Windows x86/x64/Arm, Linux x64/Arm. |
| 2024.6.10  | Add support for v1.9.2-dev on Windows x64                    |
| 2024.2.14  | Add support for v1.8.10 on Windows x86/x64, Linux x64/Arm.   |
