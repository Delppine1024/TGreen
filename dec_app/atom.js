...
(() => {
    var n = {
        883: (t, n, a) => {
            var s = a(134), l = s.app, e = s.ipcMain, c = s.BrowserWindow, d = "win32" == process.platform,
            ...
            n.bindJumplist = () => {
                ...
                d && (t = [{
                    ...
                    items: l.setting.getRecentFolders().slice(0, 5).map(function (e) {
                        return {
                            type: "task",
                            title: e.name,
                            description: e.path,
                ...
                }], l.setAppUserModelId("abnerworks.Typora"), l.setJumpList(t), i.loadDict().then(e => {
                    t[0].name = e["Recent Locations"] || "Recent Locations", t[2].items[0].title = e.New || "New", l.setAppUserModelId("abnerworks.Typora"), l.setJumpList(t)
                }))
            }, e.handle("shell.openItem", (e, t) => s.shell.openPath(t)), e.handle("shell.trashItem", async (e, t) => {
                try {
            ...
            }), e.handle("shell.showItemInFolder", (e, t) => (d && (t = t.replace(/\//g, "\\")), s.shell.showItemInFolder(t))), e.handle("dialog.showMessageBox", (e, t) => {
            ...
            const p = t => new Promise(e => {
                ...
                var n = new c({
                    skipTaskbar: !0, title: "Print PDF Preview", show: !1, webPreferences: {
                        webSecurity: !1,
                ...
                try {
                    var o, i,
                        r = t ? (console.log("load file [" + t + "] for PDF export"), n.loadURL("file:///" + t)) : (o = a(541).join(l.getPath("temp"), +new Date + "tmp.html"), i = a(728), console.log("write output to temp file [" + o + "] for PDF export"), await i.outputFile(o, e), n.loadURL("file:///" + o))
                } catch (e) {
            ...
            e.handle("export.destroyPrintView", (e, t) => {
                ...
                o = o || {}, i.webContents.print(o, (e, t) => {
                    if (!e && !/cancel/.exec(t || "")) {
                        ...
                        s.dialog.showMessageBox({
                            type: "error", message: r.getPanelString("Error"), detail: t, buttons: ["OK"]
                        })
                    }
                    o.skipCleanUp || g(n)
                })
                ...
                try {
                    ...
                    o = c.fromId(s), await p(200), i = await o.webContents.printToPDF(n), console.log("get PDF data"), r = await o.webContents.executeJavaScript("window.getComputedStyle(document.querySelector('#write')).color"), console.log("get background color")
                } catch (e) {
            ...
            function b() {
                ...
                var e = l.setting.curTheme(),
                    t = (l.execInAll("window.ClientCommand && File.setTheme('" + e + "');"), e.replace(/\.css$/, "").replace(/(^|-|_)(\w)/g, function (e, t, n, o) {
            ...
            e.handle("export.prepareImageCapture", async (e, t, n) => {
                var o;
                try {
                    if (w = s.screen.getPrimaryDisplay().scaleFactor || 1, m = n.imageWidth, await (o = new c({
                        skipTaskbar: !0,
                        show: !1,
                        webPreferences: {
                            devTools: !1,
                    ...
                    return o.isDestroyed() ? null : Number.isNaN(r) || Number.isNaN(i) ? void 0 : (u && (f = i), {
                        winId: o.id, totalHeight: r, pageHeight: f, imageWidth: n.imageWidth
                    })
                } catch (e) {
                ...
                try {
                    ...
                    return !r || r.isEmpty() ? null : (1 < w && (r = r.resize({
                        width: o.imageWidth || m, quality: "best"
                ...
                var o = {
                    ...
                    t = n ? Promise.resolve(e) : l.openFile(null, {syncAndPrepOnly: !0}).then(n => new Promise(e => {
                        let t = n.activeWindow.webContents;
                        t.isLoading() ? t.once("did-finish-load", function () {
                            e(n.activeWindow)
                        }) : e(n.activeWindow)
                    })), e = s.dialog.showOpenDialog(n ? e : null, {
                        title: i.getMenuDict.Import, properties: ["openFile"], filters: [{
                ...
                null !== l.setting.useDarkThemeBefore() && l.setting.useDarkThemeBefore() !== l.setting.useDarkTheme() && b()
            }), e.handle("theme.apply", () => {
                b()
            }), e.handle("theme.setThemeSource", (e, t) => {
                "system" !== (t = t || "system") && l.setting.get("useSeparateDarkTheme") || (s.nativeTheme.themeSource = t)
            }), e.on("ondragstart", function (t, n, o) {
                setTimeout(function () {
                    var e = s.nativeImage;
                    t.sender.startDrag({
                        file: n, icon: o ? e.createFromPath(a(541).normalize(o)) : e.createEmpty()
            ...
            var e = c(134), u = e.app, a = e.BrowserWindow, l = e.powerMonitor, h = c(728), e = c(232),
            ...
            n.prototype.watchSystemPause = function () {
                ...
                var n = this, o = this.getDocument(e), {
                    prepWindow: i, displayNow: r, forceCreateWindow: a, anchor: s
                } = t;
                if (o) {
                    var l = o.getWindowToFocus();
                    if (r && l && (l.focus(), s && l.webContent.executeJavaScript(`File.editor && File.editor.tryOpenUrl('${s.replace(/'/g, "")}')`)), !a && (!i || l)) return Promise.resolve(o)
            ...
            const y = async e => {
                ...
                return (t || {}).nodeMap ? o = await e.shouldReadFromDisk() : i = await e.popBackupState(), i && i.hasUnsaved ? console.log("load from recover content length: " + i.content.length) : i = null, JSON.stringify({
                    snap: t, filePath: n, backups: i, shouldReadFromDisk: o, windowCounts: e.windows.size
                })
            };
            t.handle("document.loadData", async e => {
                ...
                3 == u.setting.get("restoreWhenLaunch") ? u.openFile(null, {
                    mountFolder: u.setting.get("pinFolder"), silent: "pinFolder"
                }) : u.openFile()
            ...
            n.prototype.cancel = function () {
                ...
                var e = l(477), t = l(554), n = this, o = this.downloadURL, i = this.dist, r = this.displayOption,
                    a = new e(Object.assign({}, u, r)), s = ((this.progressBar = a).on("aborted", function () {
                        n.cancel()
                    }), d.dirname(i));
                Promise.all([new Promise(function (e) {
                    a.on("ready", e)
                }), c.ensureDir(s)]).then(function () {
                    console.record("[downloader] downloading " + o, "DEBUG"), t.download(a._window, o, {
                        showBadge: r.showBadge || !1, directory: s, filename: d.basename(i), onProgress: function (e) {
            ...
            a && (s = r.substr(r.length - 1 - a.length), global.devVersion = !0), l(s, "1.0.0") < 0 && process.exit(), n.handle("env.info", e => ({
                PRODUCTION_MODE: global.PRODUCTION_MODE,
                DEBUG_MODE: global.DEBUG_MODE,
                version: o.getVersion(),
                devVersion: global.devVersion
            })), global.compareVersion = l, global.t_workingDir = i, global.PRODUCTION_MODE = !0, global.DEBUG_MODE = !1
        }, 932: (e, t, n) => {
            function o() {
                this.clearUndo()
            }
            ...
            var r = n(134), a = r.app, s = n(156), l = n(728), n = r.ipcMain, c = (o.prototype.hasUndo = function (e) {
                ...
                function n() {
                    r.dialog.showMessageBox({
                        ...
                        0 == e ? r.dialog.showSaveDialog({
                            defaultPath: t.undoTo_, properties: ["showOverwriteConfirmation"]
                        }).then(({filePath: e}) => {
                            e && e != t.undoFrom_ && l.rename(t.undoFrom_, e, function (e) {
                                e && i(e)
                            }), t.clearUndo()
                        }) : t.clearUndo()
                    })
                ...
                this.hasUndo_ && (this.hasUndo_ = !1, (t = this).undoTo_ ? l.existsSync(this.undoTo_) ? n() : l.copyFile(this.undoFrom_, this.undoTo_, function (e) {
                    l.unlink(t.undoFrom_, function () {
                    }), e ? n() : (a.sendEvent("didRename", {
                        oldPath: this.undoFrom_, newPath: this.undoTo_
                    }), t.clearUndo())
            ...
            a(405);
            var u, p = a(156), h = a(134), g = h.shell, s = h.app, m = h.ipcMain, f = h.BrowserWindow,
...
`, t);
                ...
                var t = new Date;
                if (e) try {
                    var n = await a(728).stat(s.getPath("userData") + "/profile.data"), t = new Date(n.birthtime);
                    n.birthtime
                } catch (e) {
                }
            ...
            const U = () => {
                ...
                try {
                    ...
                    if (o && "zh-Hans" == s.setting.getUserLocale() && !s.setting.get("useMirrorInCN")) {
                        o = (await h.dialog.showMessageBox(null, {
                            message: "链接服务器失败，使用尝试访问国内域名进行激活?", buttons: ["确认", "取消"]
                        }))["response"];
                ...
                if (n || !(new Date - i < P / 2)) {
                    ...
                    try {
                        ...
                        const e = await a(225).post(E + "/api/client/renew", n, {
                            timeout: 4e4, headers: {"Cache-Control": "no-cache"}
                        });
                        ...
                        e.stack, r.captureException(e, {level: "warning"}), console.warn("Failed to Renew License");
                ...
                return isNaN(t.getTime()) ? e ? null : new Date : e ? t : (e = 1645454407746, isNaN(e) ? e = new Date("2021-10-01") : (e = new Date(e), isNaN(e.getTime()) && (e = new Date("2021-10-01"))), t < e ? e : t)
            }, z = (e, t) => {
                t = t || 15;
                ...
                (15 < e || isNaN(e)) && (console.log("[validateTrail] Read from incorrupted InstallDate"), await _(!0), e = 15), console.log(`[validateTrail] installDate is ${u.toLocaleDateString("en-US")}, trail remains: ${e} days`)
            };
            ...
            const j = e => {
                ...
                type: "error", buttons: ["OK"], defaultId: 0, cancelId: 0, title: e, message: t
            }), q = function () {
                s.expired = !0, $(p.getPanelString("Error"), p.getPanelString("This dev version of Typora is expired, please download and install a newer version.")).then(() => {
                ...
                var e;
                ne() && !s.setting.inFirstShow && (e = y || global.devVersion, y && Math.random() < .25 || (!F || new Date - F > 36e5 * (e ? 4 : 2) || !e && z(!0, 16) <= 0) && Q())
            };
            var t = null;
            const Q = async function (e) {
                if (F = new Date, null == t) return (t = v.showPanelWindow({
                    width: 525,
                    height: 420,
                    path: `page-dist/license.html?dayRemains=${z(!0)}&index=${e ? 1 : 0}&hasActivated=${l || !1}&email=${x}&license=${c}&lang=${s.setting.getUserLocale()}&needLicense=${te() && !global.devVersion}&type=${S}&os=` + (w ? "win" : b ? "mac" : "linux"),
                    frame: !1,
                    alwaysOnTop: !k
                })).on("closed", function () {
                    t = null
            ...
            const Z = e => {
                ...
                try {
                    return await Buffer.from(JSON.stringify({
                        v: A() + "|" + s.getVersion(), i: await M(), l: await G()
                ...
                try {
                    ...
                    if (r.captureException(e, {level: "warning"}), console.log(e.stack), !t && "off" == S) return !1
                }
                return V(), !0
                ...
                try {
                    return await async function (e, t, n) {
                        ...
                        try {
                            ...
                            }), [!1, "Failed to write your license to local machine"]) : e.response && e.response.code ? (console.warn("[License] error from server " + e.response.code), [!1, "Unknown Error. Please contact hi@typora.io"]) : (r.captureException(e, {level: "warning"}), console.error(e.stack), [!1, "Failed to access the license server. Please check your network or try again later."])
                        }
                    }(t, n, o)
                } catch (e) {
                    console.error(e.stack)
                ...
                try {
                    return n = t, await (await Y(n) ? [!0, "", x, c] : [!1, "Please input a valid license code"])
                } catch (e) {
                    console.error(e.stack)
                }
                var n
                ...
                E = s.setting.get("useMirrorInCN") ? "https://dian.typora.com.cn" : "https://store.typora.io"
            });
            const te = () => !l && !y, ne = e => L && !l;
            var oe;
            oe = (new Date).getTime();
            ...
            e.startL = async (e, t) => {
                ...
                try {
                    ee(), await M(), !e && t || y || (global.devVersion || !t || -1 < t.indexOf("dev")) && (console.log("re-write InstallDate"), await _()), l || y || global.devVersion && global.PRODUCTION_MODE && (n = N(), o = new Date, i = 1645454407746, console.log("buildTime is " + i), (isNaN(i) || o - i > 240 * P) && q(), n = +n, console.log("verInitTime is " + n), !isNaN(n) && o - n > 200 * P && q()), (async e => {
                        console.log("[watchLicense]"), j(e), await J(), l = true, console.log("[watchLicense] hasLicense: " + l), K(), U()
                    })(e)
                } catch (e) {
                ...
                n.focus()
            }, e.shouldShowWelcomePanel = te, e.getHasLicense = () => l, e.cannotContinueUse = function () {
                return !1 === l && !y && !global.devVersion && z(!0, 20) <= 0
            }
        }, 557: (o, i, F) => {
            var c, d, I = global.PRODUCTION_MODE, x = F(134), S = x.app, u = F(266), a = F(338), s = x.Menu,
                l = x.MenuItem, p = x.BrowserWindow, h = x.shell, T = "win32" == process.platform,
            ...
            function v(t) {
                var o, i, r = 0, n = S.getPath("userData") + "/typora.log", a = "", s = console.error;
                ...
                try {
                    F(728).ensureFile(n, function (e) {
                        ...
                        "DEBUG" == (t = t || "INFO") && global.PRODUCTION_MODE || l(e, t), E.captureBreadcrumb(e, t)
            ...
            function _(e) {
                var t = F(783), n = F(207), e = F(541).join(S.getPath("userData"), e);
                return t(new n(e, {
            ...
            function O(t) {
                ...
                isNaN(e) || (o = 30 < (e = (new Date - e) / 864e5 / 5) ? (n = !0, .001) : Math.max(0, (30 - e) / 30), isNaN(o) && (o = .01)), E.config("https://41af752e6d61480d85276af874a7f69b@sentry.typora.io/2", {
                    ...
                    tags: {
                        instance: C, arch: process.platform, appVersion: S.getVersion()
                    }
            ...
            e.prototype.closeLogging = function () {
                ...
                if (t.length) {
                    this.removeRecentFolder(e, !0), n.unshift({
                        name: t, path: e, date: new Date
                    }), 8 < n.length && n.splice(8), S.addRecentDocument(e);
                    try {
                        this.history.write()
                    } catch (e) {
                    }
                ...
                this.removeRecentDocument(e, !0), n.unshift({
                    name: t, path: e, date: t.length ? +new Date : 0
                }), 40 < n.length && n.splice(40), S.addRecentDocument(F(541).normalize(e));
                try {
                    this.history.write()
                } catch (e) {
                }
            ...
            var C, t, M = global.compareVersion,
                L = (e.prototype.compareVersion = global.compareVersion, e.prototype.refreshThemeMenu = function () {
                    var n, o, e = s.getApplicationMenu().getItem("Themes");
                    null != e && (n = e.submenu, o = this.curTheme(), n.clear(), this.allThemes.map(function (e) {
                        ...
                        n.append(new l({
                            label: t, type: "checkbox", checked: e == o, click: function () {
                                S.forceRefreshMenu(), S.execInAll("window.File && File.setTheme('" + e + "');"), S.setting.setCurTheme(e, t)
                            }
                        }))
            ...
            e.prototype.initSetting = async function () {
                ...
                var a = S.getPath("userData") + (T ? "\\" : "/") + "themes",
                    ...
                    u = (this.put("version", S.getVersion()), this.put("initialize_ver", "1.0.0"), this.setDefaultFonts_(), t || (this.put("line_ending_crlf", T), this.put("preLinebreakOnExport", !0)), this.generateUUID()),
                    n = (E.mergeContext({user: {id: u}}), setTimeout(function () {
                        console.log("[Raven] userId = " + u)
                    }, 100), this), p = n.allThemes, e = this.curTheme(), s = F(541), h = F(232);
                ...
                function g() {
                    ...
                    }), n.get("isDarkMode") && !n.get("useSeparateDarkTheme") && (x.nativeTheme.themeSource = "dark")
                }

                var o = 0,
                    m = (t ? (o = M(S.getVersion(), t), !(i = (t.split(/\./) || [])[1] != (S.getVersion() || []).split(/\./)[1]) && M(t, "0.11.3") < 0 && (i = !0)) : o = 1, 0 != o && (console.log("launchFromDiffVersion, pre version is " + t), this.addAnalyticsEvent("updateLocation")), n.inFirstShow = !n.get("didShowWelcomePanel2"), await W.startL(o, t), n.inFirstShow && W.shouldShowWelcomePanel() && W.showWelcomePanel(), n.put("didShowWelcomePanel2", !0), P + "/style/themes"),
                    f = a + "/old-themes";
                if (t && i) {
                    {
                    ...
                    h.list(m, function (e, t) {
                        Promise.all(t.map(function (e) {
                            ...
                            return new Promise(function (e, t) {
                                ...
                                var n = s.join(m, r), o = s.join(a, r), i = s.join(f, r);
                ...
                if (0 != o) {
                    var b = {overwrite: !0},
                        y = (D.copy(P + "/conf.default.json", S.getPath("userData") + "/conf/conf.default.json", b, d), S.getPath("userData") + "/conf/conf.user.json");
                    if (D.exists(y, function (e) {
                        ...
                        if (M(t, "0.10.11") <= 0) this.put("noHintForOpenLink", !0); else if (M(t, "0.11.17") <= 0) {
                            var i = "el";
                            const k = S.getPath("userData"), l = F(541), c = l.join(k, "typora-dictionaries"),
                                C = F(833);
                ...
                this.initDictionary_(M(t || "0.9.94", "0.9.93") <= 0), this.addAnalyticsEvent("launch"), t && 0 != o ? this.addAnalyticsEvent(0 < o ? "upgradeApp" : "downgradeApp", {
                    change: t + " → " + S.getVersion(), to: S.getVersion()
                ...
                var e, t = S.getPath("userData") + "/conf/conf.user.json";
                try {
                ...
                if (this.config.flags && this.config.flags.length) try {
                    this.config.flags.forEach(function (e) {
                        e.length && (console.log("--" + e.join(" ")), S.commandLine.appendSwitch.apply(null, e), "disable-gpu" == e.join("") && (console.log("Disable GPU Acceleration"), S.disableHardwareAcceleration()))
                    })
                } catch (e) {
                    console.error(e.stack)
                }
                ...
                if ((t = t || this.get("userLanguage", "auto")) && "auto" != t || (t = S.getLocale()), !/^ar/.exec(t)) {
                    switch (t) {
                        case"zh-CN":
                        case"zh-Hans":
                            t = "zh-Hans";
            ...
            e.prototype.loadCustomExports = function () {
                ...
                var t = S.setting.get("export.general") || {}, n = {type: e};
            ...
            var R, n = F(134).ipcMain, B = (n.on("sendLog", function (e, t) {
                    ...
                    var t = S.setting.get("export.general") || {}, n = {},
                        o = (["pdf", "html", "html-plain", "image"].forEach(e => {
                            n[e] = Object.assign({type: e}, t, S.setting.get("export." + e) || {})
                        }), {});
                    return S.setting.loadCustomExports().forEach(e => {
                        o[e.key] = Object.assign({}, t, e, S.setting.get("export." + e.key) || {})
                    }), JSON.stringify([n, o])
                }), n.handle("export.recordLastExport", (e, t) => {
                    R || (S.updateMenu({"File→Export→Export with Previous": {enabled: !0}}), S.updateMenu({"File→Export→Export and Overwrite with Previous": {enabled: !0}})), R = t, S.setting.lastExport = t, S.execInAll("File.option._lastExport = " + JSON.stringify(t))
                }), n.handle("setting.getDownloadingDicts", e => JSON.stringify(S.setting.downloadingDicts || [])), n.handle("setting.getUserDictionaryPath", e => S.setting.getUserDictionaryPath()), n.handle("setting.getUserDict", e => JSON.stringify(S.setting.userDict)), n.handle("setting.downloadDict", (e, t) => {
                    e = p.fromWebContents(e.sender);
                    S.setting.downloadDict(t, e.id)
                }), n.handle("setting.getThemes", e => ({
                    all: S.setting.getAllThemes() || [], current: S.setting.curTheme()
                })), n.handle("setting.setCurTheme", (e, t, n) => {
                    S.setting.setCurTheme(t, n)
                }), n.handle("setting.loadExportSettings", e => JSON.stringify(S.setting.loadExportSettings())), n.handle("setting.resetAdvancedSettings", (e, t) => {
                    function n() {
                    }

                    var o = F(728), i = S.getPath("userData") + "/conf/conf.user.json";
                    o.copy(P + "/conf.default.json", S.getPath("userData") + "/conf/conf.default.json", {overwrite: !0}, t ? function () {
                    ...
                    files: S.setting.getRecentDocuments() || [], folders: S.setting.getRecentFolders() || []
                })), n.handle("setting.put", (e, t, n) => {
                    S.setting.put(t, n)
                }), n.handle("setting.get", (e, t) => S.setting.get(t)), n.handle("setting.fetchAnalytics", e => {
                    var t = JSON.stringify(S.setting.analyticsEvents);
                    return S.setting.analyticsEvents = [], t
                }), null),
                N = (n.handle("setting.getUnsavedDraftsPath", e => S.setting.getUnsavedDraftPath()), e.prototype.getUnsavedDraftPath = function () {
                    return B ? Promise.resolve(B) : (B = F(541).resolve(S.getPath("userData"), "draftsRecover"), F(728).ensureDir(B).then(() => B))
                }, function (e, t, n) {
                    t && console.info(t.stack || t.message), e = e || {}, console.error(e.stack || e.message), !S.isReady() || "ENOTFOUND" != (t = e.errno || e.code) && "ETIMEDOUT" != t && "ECONNRESET" != t && 0 != (e.message || "").indexOf("net::ERR") && (dialog = F(134).dialog, stack = null != (ref = e.stack) ? ref : e.name + ": " + e.message, message = "Uncaught Exception:\n" + stack, dialog.showMessageBox(null, {
                        type: "error",
                        ...
                        1 == e ? (e = S.setting.get("useMirrorInCN") ? "typoraio.cn" : "typora.io", h.openExternal(`https://support.${e}/Version-Control/`)) : process.exit(1)
                    }))
                });
            ...
            process.on("unhandledRejection", function (e) {
                e && ("ENOTFOUND" == e.errno || "ETIMEDOUT" == e.errno || "ECONNRESET" == e.errno) || (E.captureException(e, {
                    level: "debug", tags: {category: "unhandledRejection"}
                ...
                var o, i = F(554).download, r = p.fromId(e), a = "https://dict.typora.io/",
                    s = (z("dict-download-start", n), this.userDictionaryPath), l = this.downloadingDicts;
                -1 < l.indexOf(n) || (o = function (e, t) {
                    z("dict-download-err", {
                        locale: e, message: t.message
                    }), D.unlink(s + "/_" + e + ".dic", function () {
                    }), D.unlink(s + "/_" + e + ".aff", function () {
                    }), J(l, e)
                }, l.push(n), Promise.all(["dic", "aff"].map(function (t) {
                    return console.record("[downloadDict] downloading " + (a + n + "/index." + t)), i(r, a + n + "/index." + t, {
                        directory: s, filename: "_" + n + "." + t, saveAs: !1, showBadge: !1, onCancel: function () {
                    ...
                    Promise.all([n + ".dic", n + ".aff"].map(function (e) {
                        return D.move(s + "/_" + e, s + "/" + e.replace(/-/, "_"), {overwrite: !0})
                    })).then(function () {
                    ...
                    directory: this.userDictionaryPath, filename: n + "-LICENSE", saveAs: !1, showBadge: !1
                }))
            };
            e.prototype.initDictionary_ = async function (e) {
                ...
                try {
                    var t = function () {
                            ...
                            return t
                        }(), o = S.getPath("userData"), i = F(541), r = i.join(o, "dictionaries"),
                        a = i.join(o, "typora-dictionaries");
                    if (await D.pathExists(a)) z("dict-loaded", n.userDictionaryPath = a); else try {
                        e && await D.pathExists(r) ? await D.copy(r, a) : await D.copy(t, a), E.captureBreadcrumb("copy userDictionaryPath"), z("dict-loaded", n.userDictionaryPath = a)
                    } catch (e) {
                        n.userDictionaryPath = a, F(728).ensureDir(a).then(() => {
                        }, () => {
                ...
                function s() {
                    n.userDictionaryPath && F(833).writeFile(n.userDictionaryPath + "/user-dict.json", JSON.stringify(n.userDict), function () {
                ...
                r.initDict().then(function () {
                    ...
                    console.log(e);
                    let n = F(541).normalize(S.getPath("userData") + "/picgo"), o = F(541).normalize(n + "/_picgo.zip");
                    var i = new w(e, o, {
            ...
            e.prototype.useDarkTheme = function () {
                ...
                return s.getApplicationMenu().getItem("Themes").submenu.items.map(function (e) {
                    e.checked = e.label == t
            ...
            n.handle("window.setTitle", (e, t, n) => {
                ...
                var n, o, i = g.getFocusedWindow(), r = h.setting.config || {}, a = t.lastClosedBounds,
                    s = (i = i && t.getDocumentFromWindowId(i.id) ? null : i) && i.getBounds(), l = 0,
                    s = (a || (s ? (l = i.isMaximized() || i.isFullScreen() ? 0 : 30, a = {
                        fullscreen: i.isFullScreen(), maximized: i.isMaximized()
                    }, l && (a.x = s.x + l, a.y = s.y + l, a.width = s.width, a.height = s.height)) : a = u ? (l = u.fullscreen || u.maximize ? 0 : 30, {
                        x: u.x + l,
                        y: u.y - l,
                        width: u.width,
                        height: u.height,
                        ...
                        webPreferences: {
                            ...
                            additionalArguments: ["--tyopt=" + JSON.stringify({
                                isMaximized: s, isFullScreen: a.fullscreen, ...h.setting.buildOption(), ...e
                            })]
                        },
                    ...
                    c = (f && (e.icon = w + "/assets/icon/icon_256x256.png"), r = e, i = 0 < l, l = p.screen, null != r.x && (l = (c = null == (c = l.getDisplayNearestPoint({
                        x: r.x || 0, y: r.y || 0
                    })) ? l.getPrimaryDisplay() : c).workArea, r.y < l.y ? r.y = i ? l.y + l.height - r.height : l.y : r.y + r.height > l.y + l.height && (r.y = l.y + l.height - r.height), r.x < l.x ? r.x = l.x : r.x + r.width > l.x + l.width && (r.x = i ? l.x : l.x + l.width - r.width)), u = e, s && (e.show = !1), new g(e));
                return t.lastClosedBounds = null, s && (c.maximize(), d && c.show()), a.fullscreen && (c.autoHideMenuBar = !0, c.setMenuBarVisibility(!1)), c.loadURL("file://" + w + "/window.html"), n = c, o = p.shell, n.webContents.on("will-navigate", function (e, t) {
            ...
            e.on = function (e, t) {
                ...
                var n = new g({
                    modal: !0, show: !1, center: !0, resizable: !1, webPreferences: {
            ...
            var i, a = h(134), s = a.app, g = a.dialog, l = a.Menu, c = a.MenuItem, m = a.BrowserWindow, e = a.ipcMain,
                ...
                v = (e.on("execForAll", function (e, t) {
                    ...
                    var o, e;
                    return i ? Promise.resolve(i) : (o = s.setting.getUserLocale(), e = h(541).join(u, s.setting.getLocaleFolder("Menu")), new Promise(n => {
                    ...
                    var t = e = e.toString();
                    /^\s*function\s*\(/.exec(e) && (t = "window.File && (" + e + ")();"), s.execInAll(t), console.log(t)
                }), k = function (e, t) {
            ...
            function p(e) {
                ...
                var t, n, o, i = e.label;
                return e.label = C(e.label), e.submenu ? e.submenu.forEach(p) : (void 0 !== (n = void 0 === (n = F(t = s.setting.config.keyBinding || {}, (e.label || "").replace(/[.…]/g, ""))) ? F(t, (i || "").replace(/[.…]/g, "")) : n) && (e.accelerator = n + ""), (e.accelerator || "").startsWith("global:") && (e.accelerator = e.accelerator.substr("global:".length), (o = e.click) && a.globalShortcut.register(e.accelerator, () => {
                    setTimeout(o, 0)
                }))), e
            }
            ...
            function D(e) {
                function n(e, t) {
                    e = e.label;
                    f.existsSync(e) ? s.openFileOrFolder(e, {curWindow: t}) : (g.showMessageBox({
                        title: C("Open Failed"),
                ...
                try {
                    var o = e.getItem("File").submenu.getItem("Open Recent").submenu,
                        t = s.setting.getRecentDocuments(), i = s.setting.getRecentFolders();
                    t.sort(function (e, t) {
                        return t.date - e.date
                    }), i.sort(function (e, t) {
                        return t.date - e.date
                    }), o.clear(), o.append(new c({
                        label: C("Reopen Closed File"), accelerator: "CmdOrCtrl+Shift+T", click: function () {
                            s.reopenClosed()
                        }
                        ...
                        label: "Clear Items", click: function () {
                            s.setting.clearRecentDocuments()
                        }, type: "normal"
                    }))) : o.append(new c(p({label: "No Recent Files", enabled: !1}))), l.setApplicationMenu(e)
                } catch (e) {
                }
            }

            n.getKeyAccelerator = S, l.prototype.getItem = function (e) {
                if (!e) return null;
            ...
            function P(e) {
                function t(e) {
                    ...
                    return function (e, t) {
                        var n;
                        n = o, (t = t) && (n = Object.assign({}, s.setting.exportSettingFor(n.key), n), t.webContents.send("export", n))
                    }
                }

                var n, o = [], i = (o.push({label: "PDF", click: t("pdf")}), o.push({
                    label: "HTML", click: t("html")
                }), o.push({label: "HTML (without styles)", click: t("html-plain")}), o.push({
                    label: "Image", click: t("image")
                ...
                return i.length && o.push({type: "separator"}), i.forEach(e => {
                    ...
                    label: "Export with Previous", accelerator: "Shift+CmdOrCtrl+E", click: function (e, t) {
                    ...
                    n.append(new c(e))
                }), w && l.setApplicationMenu(l.getApplicationMenu())), o
            }
            ...
            function I(e, t) {
                var n, o = t ? t.submenu : l.getApplicationMenu();
            ...
            s.updateMenu = function (e) {
                ...
                for (var t in e) {
                    var n, o, i = E(t), r = e[t];
                    i && (n = null, void 0 !== r.accelerator && (r.accelerator, o = S(i.label, r.accelerator), i = n = o != i.accelerator ? new c(p({
                        label: i.label,
                        type: i.type,
                        enabled: i.enabled,
                        checked: i.enabled,
                ...
                var t = s.setting.get("SmartyPantsOnRendering") || !1, n = s.setting.get("smartQuote") || !1,
                    o = s.setting.get("smartDash") || !1, t = [p({
                        label: "&File", submenu: [{label: "New", accelerator: "CmdOrCtrl+N", click: r("newFile")}, {
                            label: "New Window", accelerator: "CmdOrCtrl+Shift+N", click: r("newWindow")
                        }, {type: "separator"}, {
                            ...
                            label: "Reopen with Encoding", submenu: [{label: "Auto", click: e}, {type: "separator"}, {
                                label: "UTF-8", click: e
                            ...
                            label: "Reveal in Sidebar", click: r(function () {
                            ...
                            label: "Preferences…", accelerator: "CmdOrCtrl+,", click: r("togglePreferencePanel")
                        ...
                        submenu: [{label: "Undo", id: "undo", accelerator: "CmdOrCtrl+Z", click: r("undo")}, {
                            ...
                            label: "Copy Image", click: function (e, t) {
                            ...
                            label: "Copy as Markdown", accelerator: "CmdOrCtrl+Shift+C", click: r("copyAsMarkdown")
                        }, {label: "Copy as HTML Code", click: r("copyAsHTMLSource")}, {
                            label: "Copy without Theme Styling", click: r("copyAsSemanticHTML")
                        }, {type: "separator"}, {
                            label: "Paste as Plain Text", accelerator: "CmdOrCtrl+Shift+v", click: r("pasteAsPlain")
                        }, {type: "separator"}, {
                            label: "Selection", submenu: [{
                                label: "Select All", accelerator: "CmdOrCtrl+A", click: r("selectAll")
                            }, {
                            ...
                            label: "Smart Punctuation", submenu: [{
                                ...
                                label: "Remap Unicode Punctuation on Parse", type: "checkbox", click: function (e, t) {
                                    t && (e = e.checked, t.webContents.executeJavaScript("File.megaMenu.setRemapPunctuation(" + e + ")"))
                                }, checked: s.setting.get("remapPunctuation") || !t && (n || o), enabled: !(!t && (n || o))
                            }, {type: "separator"}, {
                            ...
                            label: "Line Endings", submenu: [{
                                ...
                                label: "Insert Final New Line On Save", type: "checkbox", click: function (e, t) {
                                    t && t.webContents.executeJavaScript("File.setFinalNewline(" + e.checked + ")")
                                }
                            }]
                        }, {
                            label: "Whitespace and Line Breaks", submenu: [{
                                ...
                                label: "Visible <br/>", type: "checkbox", checked: !0, click: r(function () {
                        ...
                        label: "&Paragraph", submenu: [{
                            ...
                            label: "Paragraph", type: "checkbox", accelerator: "Ctrl+0", click: r(function () {
                                File.editor.stylize.changeBlock("paragraph")
                            }, !0)
                        }, {type: "separator"}, {
                            label: "Increase Heading Level", accelerator: "Ctrl+=", click: r(function () {
                            ...
                            label: "Table", submenu: [{
                                ...
                                label: "Move Row Up", enabled: !1, accelerator: "Alt+Up", click: r(function () {
                            ...
                            label: "Quote", type: "checkbox", accelerator: "Ctrl+Shift+Q", click: r(function () {
                                File.editor.stylize.toggleIndent("blockquote")
                            }, !0)
                        }, {type: "separator"}, {
                            label: "Ordered List", type: "checkbox", accelerator: "Ctrl+Shift+[", click: r(function () {
                            ...
                            label: "Task List", type: "checkbox", click: r(function () {
                            ...
                            label: "List Indentation", submenu: [{
                        ...
                        label: "F&ormat", submenu: [{
                            ...
                            label: "Hyperlink", type: "checkbox", accelerator: "Ctrl+K", click: r(function () {
                            ...
                            label: "Image", submenu: [{
                                ...
                                label: "When Insert Local Image", submenu: [{
                            ...
                            label: "Clear Format", type: "checkbox", accelerator: "CmdOrCtrl+\\", click: r(function () {
                        ...
                        label: "&View", submenu: [{
                            ...
                            label: "Outline", type: "checkbox", accelerator: "CmdOrCtrl+Shift+1", click: r("toggleOutline")
                        }, {
                            label: "Articles",
                            type: "checkbox",
                            ...
                            label: "Search", type: "checkbox", accelerator: "CmdOrCtrl+Shift+F", click: r("globalSearch")
                        }, {type: "separator"}, {
                            label: "Source Code Mode", type: "checkbox", accelerator: "CmdOrCtrl+/", click: r(function () {
                                File.toggleSourceMode()
                            }, !0)
                        }, {type: "separator"}, {
                            label: "Focus Mode", type: "checkbox", accelerator: "F8", click: r(function () {
                            ...
                            label: "Switch Between Opened Documents", accelerator: "Ctrl+Tab", click: function (e, t) {
                                var n;
                                !t || -1 != (t = (n = m.getAllWindows()).indexOf(t)) && n[t = ++t >= n.length ? 0 : t].focus()
                            }
                        }, {type: "separator"}, {
                            label: "Toggle DevTools", accelerator: "Shift+F12", click: function (e, t) {
                                var n;
                        ...
                        label: "&Help", submenu: [{
                            ...
                            label: "Website", click: function () {
                                var e = s.setting.get("useMirrorInCN") ? "https://typoraio.cn" : "https://typora.io";
                ...
                d || t[0].submenu.splice(t[0].submenu.indexOf(null), 1), s.isEmojiPanelSupported() && (t[1].submenu.push({type: "separator"}), t[1].submenu.push(p({
                    label: "Emoji and Symbols", accelerator: d ? "Super+." : "", click: function () {
                        s.showEmojiPanel()
                    }
                })));
                const i = t[t.length - 1].submenu;
                for (; -1 < i.indexOf(null);) i.splice(i.indexOf(null), 1);
                D(n = l.buildFromTemplate(t)), l.setApplicationMenu(n), 0 < (s.setting.getAllThemes() || []).length && s.setting.refreshThemeMenu()
            ...
            "use strict";
            var p = s(93).EventEmitter, n = s(134), e = n.ipcMain, r = n.app, i = s(728),
                h = "linux" == process.platform, g = s(541).join(__dirname, "../"), m = s(445), a = s(156), f = s(477),
                w = s(824), b = s(587), l = new p, c = new Error("cancel");

            function y(a) {
                return new Promise(function (n, t) {
                    r = a, e = s(426).parse, o = s(294), i = s(764);
                    var e, o, i, r = ("https:" === (e = e(r)).protocol ? o : i).request({
                        method: "GET", hostname: e.hostname, path: e.path, port: e.port, maxRedirect: 3
                    });
            ...
            var o = ["Check updates automatically", "Skip This Version", "Remind Me Later", "Download Update", "New version available.", "Latest version is $1, your version is $2"],
                t = "64";
            "ia32" == process.arch && (t = "32"), "arm64" == process.arch && (t = "arm"), l.initUpdater = function () {
                ...
                l.progressBar && (l.progressBar.close(), l.progressBar = null), l.win && (l.win.destroy(), l.win = null);
                e = b.showPanelWindow({
                ...
                l.win || l.progressBar || (l.progressBar = new f({
                    title: a.getPanelString("Updater"),
            ...
            l.checkForUpdates = function (o) {
                ...
                if (i) {
                    if (l.emit("checking-for-update"), o) l.showUI(); else if ((e = r.setting.get("cancelUpdate")) && new Date - new Date(e) < 432e5) return;
                    return y(i).then(function (e) {
                        ...
                        var t, e = JSON.parse(e.body), n = (l.data = e, r.getVersion());
                        e.version && n && (0 < r.setting.compareVersion(e.version, n) ? (r.setting.hasUpdates = !0, r.execInAll("window.File && File.option && (File.option.hasUpdates=true)"), !o && r.setting.get("skipUpdate") == e.version || (t = e.releaseNoteLink, r.setting.get("useMirrorInCN") && (t = e.releaseNoteLinkCN || e.releaseNoteLink || "about:blank"), l.showDetailWindow(n, e.version, t))) : o && (l.showMessage(a.getPanelString("You're up to date!"), a.getPanelString("Latest version is $1, your version is $2").replace("$1", e.version).replace("$2", n)), l.cleanUp()))
                    }).catch(function (e) {
                        e === c || (o && ("zh-Hans" != r.setting.getUserLocale() || r.setting.get("useMirrorInCN") ? l.showError(a.getPanelString("Check Update Failed"), e) : l.showError(a.getPanelString("更新失败.请检查网络，或在偏好设置中启用 “Typora 服务使用国内服务器”"), e)), l.emit("error", e))
                    })
                }
            }, l.cleanUp = function () {
                l.win && (l.win.destroy(), l.win = null), l.progressBar && (l.progressBar.close(), l.progressBar = null), l.data = null
            }, l.showMessage = function (e, t) {
                l.progressBar && (l.progressBar.close(), l.progressBar = null), n.dialog.showMessageBox({
                    title: e, message: t, icon: g + "/assets/icon/icon_32x32.png", buttons: ["OK"]
                })
                ...
                var e, t, n, o = l.data.download;
                (o = r.setting.get("useMirrorInCN") ? l.data.downloadCN || l.data.download : o) && (e = "typora-update-" + process.arch + "-" + l.data.version + ".exe", t = r.getPath("temp") + (h ? "/" : "\\") + e, i.existsSync(t) ? l.askForInstall(t) : ((n = new w(o, r.getPath("temp") + "/_" + e, {
                    title: a.getPanelString("Updater"), text: a.getPanelString("Downloading Updates…")
                })).onAbort = function () {
                    l.cleanUp()
                }, n.onError = function () {
                ...
                s(620).spawn(e, ["/SILENT"], {detached: !0, stdio: ["ignore", "ignore", "ignore"]}).unref()
    ...
    (() => {
        var n, i = _(541), e = _(640),
            r = (n = i.join(__dirname, "../"), e.globalPaths.push(i.join(n, "node_modules.asar")), e.globalPaths.push(__dirname), e.prototype.require);
        e.prototype.require = function (e) {
            return /(\.node$)|(\/build\/Release)/.exec(e) && "." == e[0] && (e = i.resolve(i.dirname(this.id), e).replace(/\bnode_modules\.asar\b/, "node_modules")), r.call(this, e)
        };
        ...
        var t = _(134), c = t.app, a = t.protocol, s = t.powerMonitor, l = t.BrowserWindow, d = _(728),
            g = "win32" == process.platform, m = (process.platform, process.platform, _(557), _(344)), f = _(883),
            e = _(932), w = _(445), u = _(351), o = t.ipcMain;
        _(468);
        ...
        console.record("launch with argv [" + process.argv.join(", ") + "]"), c.on("second-instance", function (e, t, n) {
            console.record("got argv [" + t.join(", ") + "] from secondary instance"), t = Array.from(t), l.getAllWindows().length && ((n = k(t, n)) ? c.openFileOrFolder(n, {forceCreateWindow: !n}) : D(t || []))
        });
        var b = 1, y = 2, v = 3;
        ...
        var F, p, x, S = !(c.addBackup = function (t, e, n) {
            ...
            }), c.backups[t.id] = t, c.syncBackups(t.id, e), t.id, t.path, C(t.content || ""), (t.content || "").length
        }), h = (c.syncBackups = function (o, i) {
            var r = c.getPath("userData") + "/backups", a = S;
        ...
        }, []), D = (c.onCloseWin = function (e, t) {
            var n, o, i = l.fromId(e), r = c.getDocumentController(), a = r.getDocumentFromWindowId(e).path;
            n = r, o = (s = i).getBounds(), n.lastClosedBounds = n.lastClosedBounds || {}, n.lastClosedBounds.fullscreen = s.isFullScreen(), n.lastClosedBounds.maximized = s.isMaximized(), n.lastClosedBounds.fullscreen || n.lastClosedBounds.maximized || (n.lastClosedBounds.x = o.x, n.lastClosedBounds.y = o.y, n.lastClosedBounds.width = o.width, n.lastClosedBounds.height = o.height), c.setting.put("lastClosedBounds", n.lastClosedBounds), F || (F = !0, h = []), p && clearTimeout(p), p = setTimeout(function () {
                F = !1, p = null, c.setting.save()
            }, 100);
            var s = (s = c.backups[e]) || {path: a, mountFolder: t};
            h.push(s), r.removeWindow(e).then(function () {
                c.removeBackup(e), i.destroy()
            })
        }, o.on("addBackup", function (e, t, n, o) {
            (t = JSON.parse(t || "{}")).id = (l.fromWebContents(e.sender) || {}).id, void 0 !== t.id && c.addBackup(t, n, o)
        }), c.currentFocusWindowId = null, c.getCurrentFocusWindowId = function () {
            return c.currentFocusWindowId
        }, o.handle("app.openFile", (e, t, n) => ((n = n || {}).curWindow && (n.curWindow = l.fromWebContents(e.sender)), c.openFile(t || null, n).then(n => {
        ...
        }))), o.handle("app.openFileOrFolder", (e, t, n) => ((n = n || {}).curWindow && (n.curWindow = l.fromWebContents(e.sender)), c.openFileOrFolder(t || null, n))), o.handle("app.openOrSwitch", (e, n, t) => {
            var o = l.fromWebContents(e.sender), i = c.documentController.getDocument(n),
            ...
            return h.forEach(function (e) {
                e.mountFolder && !t.has(e.mountFolder) && (t.add(e.mountFolder), c.openFile(null, {
                    forceCreateWindow: !0, mountFolder: e.mountFolder
                }), n = !0)
            }), n
            ...
            return h.length && h.forEach(function (e, t) {
                ...
                n ? n.activeWindow && n.activeWindow.show() : (c.openFile(e.path, {
                    forceCreateWindow: !!t, mountFolder: e.mountFolder, silent: o, backupState: e, fromReopen: !0
                }), i = !0)
            }), i
        }, function (e) {
            ...
            try {
                n == b ? o = !c.reopenFolder() : n != y || e ? n != v || (t = c.setting.get("pinFolder")) && (c.openFile(null, {
                    forceCreateWindow: !0, mountFolder: t, pinFolder: t
                }), o = !1) : o = !c.reopenClosed(!0)
            } catch (e) {
                console.warn(e.stack)
            }
            o && c.openFileOrFolder()
        }), P = (c.recoverFromBackup = function (o) {
            async function i(e) {
                ...
                if (e.hasUnsaved) {
                    if (e.hasUnsaved) try {
                        ...
                        console.record(`[${e.id}] recover from content ${n.length} ` + C(n)), t = n.length < 2e6 ? (e.content = n, e) : (console.record("abort recovery: file too large"), null)
                    } catch (e) {
                ...
                c.openFile(e.path || null, {
                    forceCreateWindow: !0, mountFolder: e.mountFolder, backupState: t, fromReopen: !0
                })
            }
            ...
            d.readFile(r + "/sum", "utf8", function (e, t) {
                ...
                try {
                    ...
                    h = n.windows.filter(function (e) {
                        ...
                        return null != e.id
                    }), a = n.windows.length - 1, o || n.windows.length && n.innormalQuit ? (console.record("launch from abnormal quit"), n.windows.forEach(i)) : D()
                } catch (e) {
            ...
            var e, t;
            await c.setting.initSetting(), c.expired || (u.lastClosedBounds = c.setting.get("lastClosedBounds"), console.record("------------------start------------------"), console.log("typora version: " + c.getVersion()), W(), c.setAppUserModelId("abnerworks.Typora"), (e = k(process.argv)) && "--on-dev" !== process.argv[process.argv.length - 1] ? c.openFileOrFolder(e) : c.recoverFromBackup(), m.loadDict().then(() => {
                m.bindMainMenu()
            }), T(), g && (t = _(558), c.updater = t, setTimeout(function () {
                t.initUpdater().then(function () {
                    !1 !== c.setting.get("enableAutoUpdate") && c.updater.checkForUpdates(!1)
                })
            }, 3e3)), f.bindJumplist(), setTimeout(function () {
                try {
                    E()
                } catch (e) {
                    console.warn(e.stack)
            ...
            var r, a, s, l, n = await c.setting.getUnsavedDraftPath(), e = await d.readdir(n);
            e.length < 250 || (console.record("cleanUpExpiredDrafts"), 400 < e.length && (r = n, a = e, s = 0, l = new Date, e = await new Promise(n => {
                var o = [], i = async function () {
                    Math.min(s + 50, a.length);
                    if (s + 1 >= a.length) n(o); else {
                        for (; s++;) {
                            if (!a[s]) return void n(o);
                            try {
                                var e = r + "/" + a[s], t = await d.stat(e);
                                864e6 < l - t.mtime ? d.unlink(e, function () {
            ...
            })), P = null, e.sort(function (e, t) {
                return t.time - e.time
            }).forEach(function (e, t) {
                150 < t && d.unlink(n + "/" + e.name, function () {
                })
            }))
        }, I = (c.on("window-all-closed", function () {
            c.quit()
            ...
            console.log("------------------will-quit------------------"), p && clearTimeout(p), x && clearTimeout(x), g && c.updater && c.updater.installIfNeeded(), c.setting.syncAll();
            try {
            ...
            var i;
            if ("string" == typeof (n = n || !1) && (n = JSON.stringify(n)), t = t || l.getFocusedWindow()) return i = "File.option && (File.option.pinFolder = " + JSON.stringify(e) + ");\n File.editor && File.editor.library && File.editor.library.setMountFolder(" + JSON.stringify(e) + ", true, " + n + ")", setTimeout(function () {
                t.webContents.executeJavaScript(i)
            }, o || 0), t
        }, c.openFileOrFolder = function (e, t) {
            var n;
            (n = e) && _(232).isDirectorySync(n) && !/\.textbundle$/i.exec(n) ? t && t.forceCreateWindow ? u.openFile(void 0, {
                prepWindow: !0, displayNow: !0, forceCreateWindow: !0, mountFolder: e, showSidebar: !0
            }) : c.openFolder(e) : !e && t && t.forceCreateWindow ? u.openFile(void 0, {
                prepWindow: !0, displayNow: !0, forceCreateWindow: !0
            }) : c.openFile(e, t)
        }, c.openFile = function (t, e) {
            var n = (e = e || {}).curWindow || l.getFocusedWindow(), {
                syncAndPrepOnly: o, forceCreateWindow: i, fromReopen: r
            } = e;

            function a() {
                return !r && u.documents.size && w.cannotContinueUse() ? (w.showLicensePanel(), null) : u.openFile(t, {
                    prepWindow: !0, displayNow: i || !o, forceCreateWindow: i, ...e
                })
            }

            if (t = t && _(541).normalize(t), !o && t && !i && n && n.webContents && !n.webContents.isLoadingMainFrame()) {
                var s = u.getDocumentFromWindowId(n.id);
                if (s && !s.path) return n.webContents.executeJavaScript("File.changeCounter.isDiscardableUntitled()").then(function (e) {
        ...
        o.handle("app.download", (e, t, n, o) => {
            var i, r, a = _(541), s = l.fromWebContents(e.sender), e = _(554), o = o || (e => {
                var t = _(426), n = _(541), t = t.parse(e), e = n.basename(t.pathname);
                try {
            ...
            return d.existsSync(a) && (i = a, r = _(541), a = i.replace(/(\.[^.\/\\]+?$)/, "") + "-" + +new Date + r.extname(i)), I[s.id + t] || (I[s.id + t] = e.download(s, t, {
                showBadge: !1, directory: n, filename: o
            })), setTimeout(() => {
                delete I[s.id + t]
            }, 10), Promise.race([I[s.id + t].then(e => ({
                path: e.getSavePath(), state: e.getState(), type: e.getMimeType()
