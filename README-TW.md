...
| 大版本     | 推薦下載版本                                                 |
| ---------- | ------------------------------------------------------------ |
| v1.7.x     | [![GitHub release (by tag)](https://img.shields.io/github/downloads/Delppine1024/TGreen/v1.7.3/total?label=%E4%B8%8B%E8%BC%89v1.7.3&style=flat)](https://github.com/Delppine1024/TGreen/releases/tag/v1.7.3) |
...
基於 txxxxxCracker 倉庫，並獨自研發生成的用於綠化 Txxxxx v1.1 （最新支援 v1.7.4/v1.7.2-dev） 版本及以上的一些檔案。查看 **简体中文** 文档请戳 [这里](./README-CN.md) 。View the **English** version of Readme, please click [here](./README.md).
...
1. 從 **Github Releases** 中下載與 Typora 的安裝版本和 **系統版本** 相符的檔案 `app_asar_file_v1.x` 或者 `app_asar_folder_v1.x`。
   ...
   > **\*\*注意:** 如果您下載的是 `app_asar_folder_v1.x`，您需要 **手動** 生成 `app.asar` 檔案。
   >
...
| 2023.5.18  | 新增了對 Windows 64 位元系統 1.6.5 版本的支援                                         |
